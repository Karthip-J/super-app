...
function SubCategory() {
    ...
    const handleFormSubmit = async (data) => {
        ...
        const existingSubCategory = getPaginatedData().find(subCategory => subCategory.name.toLowerCase() === subCategoryName.toLowerCase());
    ...
    const handleFormUpdate = async (data) => {
        ...
        try {
            ...
            setLoading(false);
            // Reloading page is often a heavy operation. To prevent page reload, consider removing this line.
        ...
        <div className=" min-h-screen pt-6">
            ...
            <div className="w-full mx-auto">
                ...
                {openAddModal && (
                    ...
                    >
                        <div
                            className="rounded-lg shadow-2xl p-10 max-w-xl w-[35%] transition-colors"
                            style={{ backgroundColor: 'var(--bg-card)' }}
                            onClick={(e) => e.stopPropagation()}
                        >
                            <h2 className="text-2xl font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Add Sub Category</h2>

                            {/* Brand Dropdown */}
                            <div className="mb-2">
                                <label className="block text-lg font-medium mb-2" style={{ color: 'var(--text-primary)' }}>Brand<span className="text-red-500">*</span></label>
                                <Controller
                                    name="brand_id"
                                    control={control}
                                    render={({ field }) => (
                                ...
                                />
                                {errors.brand_id && <p className="text-red-500 dark:text-red-400 text-sm">{errors.brand_id.message}</p>}
                            </div>
                            ...
                            <div className="mb-2">
                                <label className="block text-lg font-medium mb-2" style={{ color: 'var(--text-primary)' }}>Sub Category Name<span className="text-red-500">*</span></label>
                                <Controller
                                ...
                                />
                                {errors.subCategoryName && <p className="text-red-500 dark:text-red-400 text-sm">{errors.subCategoryName.message}</p>}
                            </div>
                            ...
                            <div className="flex justify-end space-x-4 mt-4">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="relative bg-[#4318ff] text-white px-6 py-3 rounded-lg hover:bg-[#3a14e6] dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors disabled:opacity-50"
                                >
                                    {loading ? (
                ...
                {openEditModal && (
                    <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-50"
                        ...
                        <div 
                            ...
                            onClick={(e) => e.stopPropagation()}
                        >
                            <h2 className="text-2xl font-semibold mb-2" style={{ color: 'var(--text-primary)' }}>Edit Sub Category</h2>
                            ...
                            {/* Category Dropdown */}
                            <div className="mb-2">
                                <label className="block text-lg font-medium mb-2" style={{ color: 'var(--text-primary)' }}>Category<span className="text-red-500 ">*</span></label>
                                <Controller
                                    name="category_id"
                                    control={control}
                                    render={({ field }) => (
                                ...
                                />
                                {errors.category_id && <p className="text-red-500 dark:text-red-400 text-sm">{errors.category_id.message}</p>}
                            </div>


                            {/* SubCategory Name Input */}
                            <div className="mb-2">
                                <label className="block text-lg font-medium mb-2" style={{ color: 'var(--text-primary)' }}>SubCategory Name<span className="text-red-500 ">*</span></label>
                                <Controller
                                    name="subCategoryName"
                                    control={control}
                                    render={({ field }) => (
                            ...
                            <div className="flex justify-end space-x-4 mt-4">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="relative bg-[#4318ff] text-white px-6 py-3 rounded-lg flex items-center ml-auto max-w-xs hover:bg-[#3a14e6] dark:bg-blue-600 dark:hover:bg-blue-700 transition-colors disabled:opacity-50"
                                >
                                    {loading ? (
                            ...
                            <tr className="text-gray-600">
                                <th className="px-6 py-4 text-left">
                                    <div className="flex justify-between items-center">
                                        <input
                                            type="checkbox"
                                            checked={false}  // Removed the default check logic
                                            onChange={() => {
                                ...
                                getPaginatedData().map((category) => (
                                    <tr key={category.id} className="border-t">
                                        <td className="px-6 py-4">
                                            <input
                                                type="checkbox"
                                                checked={selectedRows.includes(category.id)} // This keeps track of whether a row is selected
